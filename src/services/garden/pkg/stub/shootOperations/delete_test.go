...
func TestCreateDeletionConfirmationPatch_PatchContainsConfirmation(t *testing.T) {
	...
	} else if v, ok := patched.GetAnnotations()["confirmation.garden.sapcloud.io/deletion"]; !ok {
		t.Fatal("no entry 'confirmation.garden.sapcloud.io/deletion' created")
	} else if v != "true" {
...
func TestCreateDeletionTimestamp_PatchContainsTimestamp(t *testing.T) {
	...
	if patched.Annotations == nil {
		t.Fatal("no annotation was created")
	} else if v, ok := patched.GetAnnotations()["confirmation.garden.sapcloud.io/deletionTimestamp"]; !ok {
		t.Fatal("no entry 'confirmation.garden.sapcloud.io/deletion' created")
