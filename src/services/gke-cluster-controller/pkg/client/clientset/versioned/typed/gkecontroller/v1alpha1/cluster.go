...
import (
	...
	scheme "github.com/infrabox/infrabox/src/services/gke-cluster-controller/pkg/client/clientset/versioned/scheme"
...
func newClusters(c *GkeV1alpha1Client, namespace string) *clusters {
	return &clusters{
		client: c.RESTClient(),
		ns:     namespace,
	}
