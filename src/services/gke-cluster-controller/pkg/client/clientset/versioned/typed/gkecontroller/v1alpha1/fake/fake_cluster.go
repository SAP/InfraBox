...
var clustersResource = schema.GroupVersionResource{Group: "gke.infrabox.net", Version: "v1alpha1", Resource: "clusters"}

var clustersKind = schema.GroupVersionKind{Group: "gke.infrabox.net", Version: "v1alpha1", Kind: "Cluster"}
