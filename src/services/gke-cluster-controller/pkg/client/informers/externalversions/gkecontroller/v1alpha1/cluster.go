...
import (
	...
	gkecontroller_v1alpha1 "github.com/infrabox/infrabox/src/services/gke-cluster-controller/pkg/apis/gkecontroller/v1alpha1"
	versioned "github.com/infrabox/infrabox/src/services/gke-cluster-controller/pkg/client/clientset/versioned"
	internalinterfaces "github.com/infrabox/infrabox/src/services/gke-cluster-controller/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/infrabox/infrabox/src/services/gke-cluster-controller/pkg/client/listers/gkecontroller/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GkeV1alpha1().Clusters(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GkeV1alpha1().Clusters(namespace).Watch(options)
			},
		},
		&gkecontroller_v1alpha1.Cluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&gkecontroller_v1alpha1.Cluster{}, f.defaultInformer)
}
