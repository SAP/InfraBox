            ...
            <md-table class="min-medium" @sort="sort">
                ...
                <md-table-body>
                    <md-table-row v-for="j in joblist" :key="j.id">
                        ...
                        <md-table-cell><div v-if="j.definition">{{ j.definition.resources.limits.cpu }} CPU</div></md-table-cell>
                        <md-table-cell v-if="j.avgCpu"><div>{{ j.avgCpu }} CPU</div></md-table-cell>
                        <md-table-cell v-if="!j.avgCpu"><div>N/A</div></md-table-cell>
                        <md-table-cell><div v-if="j.definition">{{ j.definition.resources.limits.memory }} MiB </div></md-table-cell>
