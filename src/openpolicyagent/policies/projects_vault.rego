...
# Allow POST access to /api/v1/projects/<project_id>/vault for project administrators and project token
allow {
    api.method = "POST"
    api.path = ["api", "v1", "projects", project_id, "vault"]
    api.token.type = "user"
...
# Allow DELETE access to /api/v1/projects/<project_id>/vault/<vault_id> for project administrators and project token
allow {
    api.method = "DELETE"
