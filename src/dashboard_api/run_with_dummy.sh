...
export INFRABOX_STORAGE_S3_CONTAINER_OUTPUT_BUCKET=infrabox-container-content-cache
export INFRABOX_STORAGE_S3_PROJECT_UPLOAD_BUCKET=infrabox-project-upload
export INFRABOX_STORAGE_S3_CONTAINER_CONTENT_CACHE_BUCKET=infrabox-container-output
export INFRABOX_STORAGE_S3_DOCKER_REGISTRY_BUCKET=infrabox-docker-registry
