...
def test_unsupported_version():
    run_exception('./test/unsupported_version.yml', 'version not supported, supported version is 3.2')

def test_invalid_version():
    run_exception('./test/invalid_version.yml', 'version not supported, supported version is 3.2')
